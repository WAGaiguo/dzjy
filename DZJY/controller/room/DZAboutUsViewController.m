...
- (void)configUI{
    ...
    label.attributedText = [self TitleColor:@"“菜盟萌”山东寿光大宗蔬菜电子交易平台，由寿光百胜菜盟电子商务科技有限公司在寿光市委市政府的关心和推动下，在中国（寿光）国际蔬菜博览会和寿光市蔬菜协会的支持下，聚合寿光蔬菜生产企业和专合组织，引领我国大宗蔬菜由传统的线下交易向互联网上交易转变，实现交易信息化、交易产品标准化、交易质量可追溯、交易信用可保障、交易风险可控制，促进我国蔬菜产业走向利益向产地和销地延伸、交易成本向中间大幅下降、交易产品向品牌高端促进发展。\n\n平台以交易为核心，聚合蔬菜产业资源，形成专业的蔬菜产业互联网平台，为蔬菜产业提供产地管理支撑、交易支撑、物流支撑、金融服务支撑，将平台打造为全国蔬菜产业综合服务平台。实现一二三产业融合发展，实现寿光蔬菜产业转型升级，实现质量兴农、绿色兴农、品牌强农！"];
    [label sizeToFit];
